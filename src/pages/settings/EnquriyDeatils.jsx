    ...
    return (
        <div className='page-container'>
            <div className='inner-page-container'>
                <div class="header">
                    <div>
                        <h2 class="title text-on-surface">Contact Enquiry Details</h2>
                        <p class="subtitle">Manage your Enquries</p>
                    </div>
                </div>
                <div>
                    {/* 🔍 Search */}
                        ...
                        <table className="table">
                            <thead className="bg-gray-100 text-left">
                                <tr className='thead-row'>
                                    ...
                                    <th className="th">Inquiry Type</th>
