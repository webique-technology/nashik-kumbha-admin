...
<div className="page-container">
  ...
  <section className="header">
    <div>
      <h2 className="title text-on-surface">Hotel Listings</h2>
  ...
  <section className="filter">
    ...
    <div className="filter-item-sm">
      <label className="label text-on-surface-variant">Date Range</label>
      <button className="date-btn text-on-surface-variant">
    ...
    <table className="table">
      ...
      <thead>
        <tr className="thead-row">
          ...
          <th className="th th-center">Bookings</th>
      ...
      <tbody className="tbody">
        ...
        <tr className="tr group">
          ...
          <td className="td"><span className='px-6 py-4 font-mono text-[11px] text-on-surface-variant'>IN-AGR-092</span></td>
        ...
        <tr className="tr group">
          ...
          <td className="td"><span className='px-6 py-4 font-mono text-[11px] text-on-surface-variant'>CH-ZRM-044</span></td>
          <td className="td">
