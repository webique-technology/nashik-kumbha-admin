          ...
          {secondaryMetrics.map((item) => (
            ...
            >
              ...
              <div>
                ...
                <h3 className="secondary-metric-value" style={{ color: item.textColor }}>{item.value}</h3>
              </div>
              ...
              {packageData.map((pkg) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    {/* Button */}
                    <button onClick={() => navigate("/dashboard/tours")} className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary py-3 font-medium text-white transition hover:opacity-90">
                      View Details
                ...
                >
                  ...
                  <div className="p-6">
                    <div className='flex items-center justify-between mb-4'>
                      ...
                      <p className='flex items-center mb-2 gap-2 text-xs'>
                        <FiUsers />
                        22
                      </p>
                    </div>
                    ...
                    {/* Button */}
                    <button onClick={() => navigate("/dashboard/hotel")} className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary py-3 font-medium text-white transition hover:opacity-90">
                      View Details
                      <span className="material-symbols-outlined">
                        arrow_forward
                      </span>
              ...
              {vehicleData.map((pkg) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    {/* Button */}
                    <button onClick={() => navigate("/dashboard/vehicle")} className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary py-3 font-medium text-white transition hover:opacity-90">
                      View Details
                      <span className="material-symbols-outlined">
                        arrow_forward
                      </span>
